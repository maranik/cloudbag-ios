...
+ (UIColor*)colorOfNavigationBar{
    return [UIColor colorWithRed:0/255.0f green:134/255.0f blue:214/255.0f alpha:1.0];
}
...
+ (UIColor*)colorOfTintUITabBar {
    return [UIColor colorWithRed:218/255.0f green:218/255.0f blue:218/255.0f alpha:1.0];
}
...
+(UIColor *)colorOfLoginButtonBackground{
    return [UIColor colorWithRed:0/255.0f green:194/255.0f blue:54/255.0f alpha:1.0];
}
